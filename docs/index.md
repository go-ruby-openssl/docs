# go-ruby-openssl documentation

**Pure-Go, MRI-4.0.5-faithful Ruby openssl (no cgo)**

`go-ruby-openssl/openssl` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `openssl`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-openssl/openssl`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `openssl`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`openssl`](https://github.com/go-ruby-openssl/openssl) | the library — Ruby's `openssl` in pure Go |
| [`docs`](https://github.com/go-ruby-openssl/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-openssl.github.io`](https://github.com/go-ruby-openssl/go-ruby-openssl.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-openssl/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-openssl/openssl](https://github.com/go-ruby-openssl/openssl).
